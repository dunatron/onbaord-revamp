...
//check media query
        ...
        //define store some initial variables
            halfWindowH = Nzicrec.win.height() * 0.5,
            halfWindowW = Nzicrec.win.width() * 0.5,
        ...
        Nzicrec.win.on('resize', function () {
        ...
        function initBackground() {
            ...
            var jobSectorsHeight = jobSectors.outerHeight();
            if (jobSectorsHeight > wrapperHeight) {
                wrapperHeight = jobSectorsHeight;
            }
